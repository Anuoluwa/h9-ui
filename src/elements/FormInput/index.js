...
export const FormInput = ({ handleChange, className, icon, type, placeholder, label, ...otherProps}) => {
    return(
...
export const FormSelectInput = ({className, label, value, name, handleChange, options, ...otherProps}) => {
    return(
